...
mkdirSync('src/app/publishers', { recursive: true });
mkdirSync('src/components/ui', { recursive: true });

// ─── PDF VIEWER MODAL ─────────────────────────────────────────────────────────
const pdfViewer = `'use client';
...
// ─── PUBLISHERS PAGE ──────────────────────────────────────────────────────────
const publishersPage = `'use client';
...
writeFileSync('src/components/ui/PdfViewerModal.tsx', pdfViewer, 'utf8');
writeFileSync('src/app/publishers/page.tsx', publishersPage, 'utf8');
console.log('PdfViewerModal:', pdfViewer.length);
console.log('publishers/page.tsx:', publishersPage.length);
