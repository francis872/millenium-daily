...
// ── ContentTypePill component ──
const contentTypePill = `'use client';
import { cn } from '@/lib/utils';
...
writeFileSync('src/components/ui/TrustBadge.tsx', trustBadge, 'utf8');
writeFileSync('src/components/ui/ContentTypePill.tsx', contentTypePill, 'utf8');
console.log('TrustBadge:', trustBadge.length, 'ContentTypePill:', contentTypePill.length);
